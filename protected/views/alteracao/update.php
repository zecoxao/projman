...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->cod_alteracao) => array('view', 'id'=>$model->cod_alteracao),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->cod_alteracao)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Alteracao::label(); ?> <?php echo CHtml::encode($model) ?></legend>
