...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->cod_stakeholder) => array('view', 'id'=>$model->cod_stakeholder),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->cod_stakeholder)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Stakeholder::label(); ?> <?php echo CHtml::encode($model) ?></legend>
