...
$this->menu=array(
	array('label'=>'Stakeholder','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('stakeholder-grid')\",5000);
");
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		array(
	        'name'=> 'cod_stakeholder',
	        'value' => '($data->cod_stakeholder)',
	    ...
	    */
		array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->cod_stakeholder."|".$data->cod_stakeholder',              
                	'click' => 'function(){
