...
Yii::app()->clientScript->registerScript('search', "
	...
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('grupo-analise-grid', {
			data: $(this).serialize()
		});
		return false;
	});
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('grupo-analise-grid')\",5000);
");
	    ...
	    */
		array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->cod_grupo."|".$data->cod_grupo',              
                	'click' => 'function(){
