...
$this->menu=array(
	array('label'=>'Estado','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('estado-grid')\",5000);
");
	    ...
	    */
		array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->cod_estado."|".$data->cod_estado',              
                	'click' => 'function(){
