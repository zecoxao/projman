...
/* @var $model ProjectoMultiple */

$this->breadcrumbs=array(
	'Projecto Multiples'=>array('index'),
	$model->cod_projecto,
);
...
<?php $box = $this->beginWidget(
    ...
    array(
        'title' => 'View Projecto Multiples #'.$model->cod_projecto,
	...
	'attributes'=>array(
		...
		'descricao',
			...
			array(
		        'name'=> 'data_inicio',
		        'type'=>'raw',
		        'value' => date("l, d M Y",strtotime($model->data_inicio)),
		    ),
			...
			array(
		        'name'=> 'data_fim',
		        'type'=>'raw',
		        'value' => date("l, d M Y",strtotime($model->data_fim)),
		    ),
