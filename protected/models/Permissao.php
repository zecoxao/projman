 ...
 * @property integer $cod_permissao
...
class Permissao extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cod_permissao, descricao', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'membros' => array(self::HAS_MANY, 'Membro', 'permissao'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('cod_permissao',$this->cod_permissao);
