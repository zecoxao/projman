...
class Stakeholder extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'pessoa1' => array(self::HAS_MANY, 'Pessoa', array('pessoa' => 'cod_pessoa'), 'through' => 'cliente0'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('pessoa1.nome', $this->nome_cliente, true);
        $criteria->addSearchCondition('pessoa0.nome', $this->nome_stakeholder);
