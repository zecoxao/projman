...
class StakeholderMembroController extends RController
{
	...
	public function actionCreate()
	{
        ...
        $this->performAjaxValidation($model, 'stakeholder-membro-form');
	...
	{
		$model = StakeholderMembro::model()->findByPk($id);
		if($model === null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax'] === 'stakeholder-membro-form')
		{
